...
public class SqlMigrationResolverSmallTest {
    ...
    public void resolveMigrations() {
        SqlMigrationResolver sqlMigrationResolver = 
                new SqlMigrationResolver(null, scanner,
                        new Location("migration/subdir"), PlaceholderReplacer.NO_PLACEHOLDERS, "UTF-8", "V", "R", "__", ".sql", new AlwaysFailSqlMigrationErrorHandler());
    ...
    public void resolveMigrationsRoot() {
        SqlMigrationResolver sqlMigrationResolver = 
                new SqlMigrationResolver(null, scanner, new Location(""),
                        PlaceholderReplacer.NO_PLACEHOLDERS, "UTF-8", "CheckValidate", "X", "__", ".sql", new AlwaysFailSqlMigrationErrorHandler());
        ...
        SqlMigrationResolver sqlMigrationResolver = 
                new SqlMigrationResolver(null, scanner,
                        new Location("non/existing"), PlaceholderReplacer.NO_PLACEHOLDERS, "UTF-8",
                            "CheckValidate", "R", "__", ".sql", new AlwaysFailSqlMigrationErrorHandler());
    ...
    public void extractScriptName() {
        SqlMigrationResolver sqlMigrationResolver = 
                new SqlMigrationResolver(null, scanner,
                        new Location("db/migration"), PlaceholderReplacer.NO_PLACEHOLDERS, "UTF-8", "db_", "R", "__", ".sql", new AlwaysFailSqlMigrationErrorHandler());
    ...
    public void extractScriptNameRootLocation() {
        SqlMigrationResolver sqlMigrationResolver = 
                new SqlMigrationResolver(null, scanner, new Location(""),
                        PlaceholderReplacer.NO_PLACEHOLDERS, "UTF-8", "db_", "R", "__", ".sql", new AlwaysFailSqlMigrationErrorHandler());
